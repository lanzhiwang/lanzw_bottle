...
# -*- coding: utf-8 -*-
"""
https://github.com/bottlepy/bottle/commit/7616b678827c5d7eff8b265776f9b08203966d1d#diff-ad8cb2f640fd3a70db3fc97f3044a4e6
...
class Bottle(object):
    ...
    def route(self, url, method='GET', **kargs):
        ...
        def wrapper(handler):
            # print 'Bottle route: {}'.format(self.routes)
            # {'POST': <bottle.Router object at 0x2bb1950>, 'GET': <bottle.Router object at 0x2bb1890>}
...
class ServerAdapter(object):
    ...
    # server(host=host, port=port, **kargs)
...
# run(host='0.0.0.0', reloader=False, port=int(sys.argv[1]), server=bottle.WSGIRefServer)
...
def run(app=None, server=WSGIRefServer, host='127.0.0.1', port=8080,
    ...
    try:
        if reloader and interval:
            ...
            server.run(app)
    except KeyboardInterrupt:  # 按 Ctrl-C 触发异常
...
def reloader_run(server, app, interval):
    print 'os.environ.get(\'BOTTLE_CHILD\'): {}'.format(os.environ.get('BOTTLE_CHILD'))
    if os.environ.get('BOTTLE_CHILD') == 'true':
        ...
        for module in sys.modules.values():
            ...
            # /root/work/lanzw_frame/evolution/evolution_0015/homepage/bottle.pyc
        ...
        while True:
            ...
            for file_path, file_mtime in files.iteritems():
                ...
                sys.exit(3)
    while True:
        print sys.executable  # /root/work/lanzw_frame/evolution/evolution_0015/venv/bin/python
        args = [sys.executable] + sys.argv
        print args  # ['/root/work/lanzw_frame/evolution/evolution_0015/venv/bin/python', 'app.py', '8080']
        ...
        {
        'BOTTLE_CHILD': 'true', 
        'PATH': '/root/work/lanzw_frame/evolution/evolution_0015/venv/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/root/bin', 
        'VIRTUAL_ENV': '/root/work/lanzw_frame/evolution/evolution_0015/venv', 
        '_': '/root/work/lanzw_frame/evolution/evolution_0015/venv/bin/python'
        }
        """
        print os.environ.get('BOTTLE_CHILD')  # None
