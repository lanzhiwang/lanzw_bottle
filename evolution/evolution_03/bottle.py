...
class Bottle(object):
    ...
    def add_controller(self, route, controller, **kargs):
        ...
        # print('route: %s, controller: %s, kargs: %s' % (route, controller, kargs))
        ...
        # print([m for m in dir(controller) if not m.startswith('_')])  # ['yes', 'yes2']
    ...
    def add_route(self, route, handler, method='GET', simple=False, **kargs):
        ...
        # print('add_route')
        # print('route: %s, handler: %s, method: %s, simple: %s, kargs: %s' % (route, handler, method, simple, kargs))
        # print(isinstance(handler, type))
        # print(issubclass(handler, BaseController))
        # print(isinstance(handler, BaseController))
    ...
    def __call__(self, environ, start_response):
        ...
        try: # Unhandled Exceptions
            try: # Bottle Error Handling
                if not self.serve:
                    abort(503, "Server stopped")  # raise HTTPError(code, text)
...
"""
add_route
route: /ctest/{action}, handler: <class '__main__.CTest'>, method: GET, simple: False, kargs: {}
add_controller
route: /ctest/{action}, controller: <__main__.CTest object at 0x1b6e2d0>, kargs: {'simple': False, 'method': 'GET'}
['yes', 'yes2']
add_route
route: /ctest/yes, handler: <bound method CTest.yes of <__main__.CTest object at 0x1b6e2d0>>, method: GET, simple: False, kargs: {}
add_route
route: /ctest/yes2, handler: <bound method CTest.yes2 of <__main__.CTest object at 0x1b6e2d0>>, method: GET, simple: False, kargs: {}
"""

# app.add_route('/ctest/yes/:test', CTest, action='yes2')
"""
add_route
route: /ctest/yes/:test, handler: <class '__main__.CTest'>, method: GET, simple: False, kargs: {'action': 'yes2'}
add_controller
route: /ctest/yes/:test, controller: <__main__.CTest object at 0xf142d0>, kargs: {'action': 'yes2', 'simple': False, 'method': 'GET'}
['yes', 'yes2']
add_route
